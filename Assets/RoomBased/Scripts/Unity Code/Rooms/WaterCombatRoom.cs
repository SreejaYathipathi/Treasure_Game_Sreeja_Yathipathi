...
public class WaterCombatRoom : RoomBase
{
    ...
    {
        Debug.Log("You have entered the Water Combat Room room.");
        ...
        if (!_hasBeenSearched)
        {
            ...
            _uiManager.WaterCombatPanel(); // Show the treasure search panel
        }
    ...
    {
        Debug.Log("You have exited the Water Combat Room room.");
