...
public class CombatRoom : RoomBase
{
    ...
    {
        Debug.Log("You have entered the Fire Combat Room room.");
        ...
        if (!_hasBeenSearched)
        {
            ...
            _uiManager.FireCombatPanel(); // Show the treasure search panel
        }
    ...
    {
        Debug.Log("You have exited the Fire Combat Room room.");
